...
<form action="/createPersonInfo" method="post">
    ...
    <div>
        <br>
        <label for="passwordId">Придумайте password:
            <input type="password" name="password" id="passwordId">
        </label>
        <span>Вы можете использовать целые числа, буквы и подчеркивание</span>
        <span>  главное не забыть придуманный пароль ;)</span>
        <br>
    </div>
